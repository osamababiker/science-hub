...
export default function Instractors({teachers}) {
        ...
        <div className="container">
          <div className="row y-gap-20 justify-between items-center">
            <div className="col-auto">
              <h2 className="text-24 lh-12">{t('instructorsTitle')}</h2>
            </div>
                    ...
                    <div className="swiper-slide">
                      <div className="teamCard -type-1 -teamCard-hover">
                        ...
                        <div className="teamCard__content text-center">
                          ...
                          <p className="teamCard__text">{locale == 'en' ? elm.role_en : elm.role_ar}</p>
