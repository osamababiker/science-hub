        ...
        <div className="pt-60 lg:pt-40">
          <div className="overflow-hidden js-section-slider">
            ...
            <div className="d-flex justify-center x-gap-15 items-center pt-60 lg:pt-40">
              <div className="col-auto">
                <button className="d-flex items-center text-24 arrow-right-hover js-prev icon-arrow-right-event-six">
              ...
              <div className="col-auto">
                <button className="d-flex items-center text-24 arrow-left-hover js-next icon-arrow-left-event-six">
