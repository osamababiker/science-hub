...
export const arLinks = [
  { id: 1, href: "/help-center", label: "المساعدة" },
  { id: 2, href: "/terms", label: "سياسة الخصوصية" },
  { id: 3, href: "/terms", label: " ملفات تعريف الارتباط" },
  { id: 4, href: "/terms", label: "حماية" },
  { id: 5, href: "/terms", label: "سياسة الاستخدام" },
];
