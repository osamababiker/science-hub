export const testimonials = [
  {
    ...
    comment: "Great Work",
    description: `at science hub we had the best online educational experience ever, the teachers were great and the course was amazing.`,
  },
  {
    id: 1,
...
export const arTestimonials = [
  {
    ...
    position: "مصمم ويب",
    comment: "تجربة رائعة",
    description: `في مركز العلوم، حصلنا على أفضل تجربة تعليمية عبر الإنترنت على الإطلاق، وكان المعلمون رائعين وكانت الدورة مذهلة.`,
  },
  {
    id: 1,
    imageSrc: "/assets/img/testimonials/2.png",
